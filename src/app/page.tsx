            ...
            <div>
              {sent ? (
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
                  ...
                  <button className="btn-primary" style={{ background: c.accent, color: "#fff", border: "none", padding: "12px 24px", borderRadius: 10, fontSize: 14, fontWeight: 600, cursor: "pointer", fontFamily: "inherit", width: isMobile ? "100%" : "fit-content", minHeight: 46, marginTop: 2 }} onClick={() => setSent(true)}>Send message</button>
                </div>
              )}
            </div>
          </div>
